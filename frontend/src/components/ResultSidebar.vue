...
<template>
  <aside class="space-y-6">
    <article class="rounded-[36px] border border-white/70 bg-white/88 p-6 shadow-card sm:p-7">
      ...
      <div class="mt-5 space-y-3">
        <div
          ...
          class="rounded-[22px] bg-[#f8f4ee] px-4 py-4 text-sm text-slate-600"
        >
          ...
          <div class="mt-3 text-xs text-[#8d673f]">{{ stay.nightly_budget }}</div>
        </div>
      </div>
    </article>
    ...
    <article class="rounded-[36px] border border-white/70 bg-white/88 p-6 shadow-card sm:p-7">
      ...
      <div class="mt-5 space-y-3">
        <div
          ...
          :key="tip"
          class="rounded-[22px] bg-panel px-4 py-4 text-sm leading-7 text-slate-600"
        >
          {{ tip }}
        </div>
      </div>
    ...
    >
      ...
      <div class="mt-5 rounded-[22px] bg-panel px-4 py-4 text-sm text-slate-600">
      ...
      <div class="mt-4 rounded-[22px] bg-panel px-4 py-4 text-sm text-slate-600">
      ...
      <div
        ...
        class="mt-4 rounded-[22px] bg-panel px-4 py-4 text-sm text-slate-600"
      >
